...
async function getSongs(folder) {
    let a = await fetch(`https://github.com/Hackame007/Hackame007.github.io/tree/main//songs/${folder}`)
...
async function display_albums() {
    let a = await fetch(`https://github.com/Hackame007/Hackame007.github.io/tree/main//songs`)
    let resp = await a.text();
    let div = document.createElement("div")
    div.innerHTML = resp
    ...
    for (let index = 0; index < arr.length; index++) {
        ...
        if(e.href.includes("/songs") && !e.href.includes(".htaccess")){
            ...
            let a = await fetch(`https://github.com/Hackame007/Hackame007.github.io/tree/main/songs/${folder}/info.json`)
